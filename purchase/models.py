...
from tagging.models import CalculationType
...
class NewPurchase(models.Model):
    ...
    is_canceled = models.BooleanField(verbose_name="Cancelled", null=True,blank=True,default=False)
...
class NewPurchaseItemdetail(models.Model):
    ...
    itemid  = models.CharField(max_length=100,verbose_name="item id",null=True,blank=True)
    ...
    calculation_type = models.ForeignKey(CalculationType,verbose_name="calculation type",null=True,blank=True,on_delete=models.PROTECT)
    fixed_rate = models.FloatField(max_length=100,verbose_name="fixed rate",null=True,blank=True,default=0.0)
    per_gram_rate = models.FloatField(max_length=100,verbose_name="per gram rate",null=True,blank=True,default=0.0)
    per_piece_rate = models.FloatField(max_length=100,verbose_name="per piece rate",null=True,blank=True,default=0.0)
    ...
    stone_pieces = models.IntegerField(verbose_name="stone  pieces",null=True,blank=True,default=0)
    stone_weight =models.FloatField(max_length=100,verbose_name="stone weight",null=True,blank=True,default=0.0)
    reduce_stone_weight = models.BooleanField(verbose_name="Reduce Stone Weight",default=False)
    diamond_pieces = models.IntegerField(verbose_name=" diamond pieces",null=True,blank=True,default=0)
    diamond_weight =models.FloatField(max_length=100,verbose_name="diamond weight",null=True,blank=True,default=0.0)
    reduce_diamond_weight = models.BooleanField(verbose_name="Reduce Diamond Weight",default=False)
    ...
    other_charges = models.IntegerField(verbose_name="others",null=True,blank=True,default=0)
    hallmark_charges = models.IntegerField(verbose_name="hallmark",null=True,blank=True,default=0)
    created_at = models.DateTimeField(verbose_name="Created at", null=True)
